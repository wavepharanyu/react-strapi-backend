            ...
            <div className="hidden sm:block sm:ml-6">
              <div className="flex space-x-4">
                ...
                <NavLink to="/" className={({ isActive }) => 
                    `text-gray-300 ${isActive ? 'bg-green-500 text-white' : 'hover:bg-gray-700 hover:text-white'}  rounded-md px-3 py-2 text-sm font-medium`
                  }>
                  Home
                </NavLink>
...

        {
          <div className={`${isOpen ? 'sm:hidden block': 'sm:hidden hidden'}`} id="mobile-menu">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <NavLink to="/" className={({ isActive }) => `text-gray-300 ${isActive ? 'bg-green-500 text-white' : 'hover:bg-gray-700 hover:text-white'} block px-3 py-2 rounded-md text-base font-medium` }>
                Home
              </NavLink>
              <NavLink to="/about" className={({ isActive }) => `text-gray-300 ${isActive ? 'bg-green-500 text-white' : 'hover:bg-gray-700 hover:text-white'} block px-3 py-2 rounded-md text-base font-medium` }>
                About
              </NavLink>
              <NavLink to="/teams" className={({ isActive }) => `text-gray-300 ${isActive ? 'bg-green-500 text-white' : 'hover:bg-gray-700 hover:text-white'} block px-3 py-2 rounded-md text-base font-medium` }>
                Teams
              </NavLink>
              <NavLink to="/projects" className={({ isActive }) => `text-gray-300 ${isActive ? 'bg-green-500 text-white' : 'hover:bg-gray-700 hover:text-white'} block px-3 py-2 rounded-md text-base font-medium` }>
                Projects
              </NavLink>
              <button type="button" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 inline-flex rounded-md text-sm font-medium" aria-expanded="false" onClick={() => {setIsActive(!isActive)}}>
                  <span>More</span>
